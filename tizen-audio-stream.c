...
static int _sample_spec_valid(uint32_t rate, audio_sample_format_t format, uint32_t channels)
{
    if ((rate <= 0                 ||
        rate > (48000U*4U)         ||
        channels <= 0              ||
...
static uint32_t _audio_usec_to_bytes(uint64_t t, uint32_t rate, audio_sample_format_t format, uint32_t channels)
{
...
static uint32_t _audio_sample_size(audio_sample_format_t format)
{
...
audio_return_t audio_stream_get_buffer_attr(void                  *audio_handle,
                                     uint32_t              direction,
                                     const char            *latency,
                                     uint32_t              samplerate,
